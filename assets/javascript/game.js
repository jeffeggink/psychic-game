...
var guessedLetters = []; //keeps track of key letters entered 
...
document.onkeyup = function (event) {
  ...
  var html = "<p>There's only 26 letters. Guess which one I'm thinking</p>" + "<p>Wins: " + Win + "</p>" + "<p>Loses: " + Lose + "<p>Guesses Left: " + guessesRemaining + "<p>Your Guesses so far: " + guessedLetters.join(', '); //Reveal guessed letters here
